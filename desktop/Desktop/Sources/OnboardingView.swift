    ...
    Group {
      if currentStep == 0 {
        ...
        OnboardingPermissionStepView(
          ...
          totalSteps: OnboardingFlow.introStepCount,
          eyebrow: "Permission",
          title: "Let Ollami read your screen.",
          description: "Screen Recording lets Ollami see what you're working on.",
          permissionType: "screen_recording",
          icon: "display.and.arrow.down",
          reasonTitle: "Screen Recording",
          reasonDetail: "Screen Recording lets Ollami see what you're working on.",
        ...
        OnboardingPermissionStepView(
          ...
          totalSteps: OnboardingFlow.introStepCount,
          eyebrow: "Access",
          title: "Let Ollami scan your work.",
          description: "File access lets Ollami map your projects and files.",
          permissionType: "full_disk_access",
          icon: "externaldrive.fill.badge.person.crop",
          reasonTitle: "Disk Access",
          reasonDetail: "This lets Ollami scan your projects and recent files.",
        ...
        OnboardingPermissionStepView(
          ...
          totalSteps: OnboardingFlow.introStepCount,
          eyebrow: "Permission",
          title: "Let Ollami use your mic.",
          description: "Microphone lets Ollami transcribe meetings.",
          permissionType: "microphone",
          icon: "mic.fill",
          reasonTitle: "Microphone",
          reasonDetail: "This lets Ollami transcribe meetings and voice notes.",
        ...
        OnboardingPermissionStepView(
          ...
          totalSteps: OnboardingFlow.introStepCount,
          eyebrow: "Permission",
          title: "Let Ollami see the active app.",
          description: "Accessibility lets Ollami know which app is active.",
          permissionType: "accessibility",
          icon: "figure.wave",
          reasonTitle: "Accessibility",
          reasonDetail: "This lets Ollami know which app you are using.",
        ...
        OnboardingPermissionStepView(
          ...
          totalSteps: OnboardingFlow.introStepCount,
          eyebrow: "Permission",
          title: "Let Ollami act when asked.",
          description: "Automation lets Ollami take actions for you.",
          permissionType: "automation",
          icon: "bolt.horizontal.circle.fill",
          reasonTitle: "Automation",
          reasonDetail: "This lets Ollami take actions when you ask.",
